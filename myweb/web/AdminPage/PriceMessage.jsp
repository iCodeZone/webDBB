...
<div class="row">
  ...
  <div class="function col-xs-12">
    <ol class="breadcrumb">
      ...
      <li><a href="/myweb/getBuys">查询订单</a></li>
...
<%GoodsBean good=(GoodsBean)session.getAttribute("good");  %>
<div style="width:100%;">
  <form action="/myweb/setPrice" method="post">
      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="请输入要修改的金额" name="gprice">
          </div>
        </td>
      </tr>
    </table>
